...
async function init() {
  ...
  const customMapStr = localStorage.getItem('custom_map_data_v0.116');
  ...
  if (continueButton) {
    if (localStorage.getItem('saved_game_state_v0.116')) {
...
export function saveGameState() {
  ...
  try {
    ...
    localStorage.setItem('saved_game_state_v0.116', JSON.stringify(saveState));
...
export function loadGameState() {
  const data = localStorage.getItem('saved_game_state_v0.116');
