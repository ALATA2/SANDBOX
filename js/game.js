...
async function init() {
  ...
  const customMapStr = localStorage.getItem('custom_map_data_v0.104');
  ...
  if (continueButton) {
    if (localStorage.getItem('saved_game_state_v0.104')) {
...
export function saveGameState() {
  ...
  try {
    ...
    localStorage.setItem('saved_game_state_v0.104', JSON.stringify(saveState));
...
export function loadGameState() {
  const data = localStorage.getItem('saved_game_state_v0.104');
